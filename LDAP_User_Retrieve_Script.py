...
"""
Purpose: The LDAP_Member_List script is used to retrieve LDAP users.
Usage: python3 /ur_path/zabbix-ldap-prodori-mod-20250507-2.py -l -f /ur_path/zabbix-ldap.conf > /home_ad/769194/TestingResult1.log 2>&1
Created: 17/7/2025 - Wan
